...
export default function MasjidPartnership() {
    ...
    return (_jsxs("div", { className: "rounded-xl shadow-sm space-y-4", children: [_jsx("p", { className: "text-sm", style: { color: theme.silver2 }, children: "Masjidku menawarkan kepada seluruh muslimin khususnya Masjid dan Lembaga Islam untuk saling bekerjasama dalam kebaikan dengan Masjidku." }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsx(SupportCard, { title: "\uD83C\uDF31 Masjidku", description: _jsxs(_Fragment, { children: ["Gabung bersama dalam satu aplikasi untuk management Masjid dan Lembaga.", _jsx("strong", { children: " Insya Allah 100% Gratis." })] }), action: _jsx(Button, { children: "Informasi" }) }), _jsx(SupportCard, { title: "\uD83D\uDCCA Aplikasi & Web Sendiri", description: "Buat khusus untuk Masjid dan Lembaga dengan branding aplikasi dan web sendiri bekerjasama dengan Masjidku.", action: _jsx(Button, { style: {
