...
export const QK = {
    ...
    ASSIGNMENTS: (classId) => ["teacher-class-assignments", classId],
};
// ========================
...
// ========================
export async function fetchAssignmentsByClass(classId) {
    return Promise.resolve([...(DB_ASSIGNMENTS[classId] ?? [])]);
}
export async function fetchAssignmentById(classId, assignmentId) {
...
// ========================
export function addAssignment(classId, payload) {
    const item = {
        id: `a-${Date.now()}`,
...
export function updateAssignment(classId, assignmentId, patch) {
