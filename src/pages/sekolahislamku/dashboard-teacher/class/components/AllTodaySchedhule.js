...
export default function AllTodaySchedule() {
    ...
    return (_jsxs("div", { className: "min-h-screen w-full", style: { background: palette.white2, color: palette.black1 }, children: [_jsx(ParentTopBar, { palette: palette, gregorianDate: new Date().toISOString(), title: "Jadwal 7 Hari Kedepan", dateFmt: (iso) => new Date(iso).toLocaleDateString("id-ID", {
                    ...
                    year: "numeric",
                                                    ...
                                                    background: palette.white1,
                                                }, children: "Belum ada jadwal pada hari ini." })) : (_jsx("div", { className: "divide-y", style: { borderColor: palette.silver1 }, children: items.map((s, i) => (_jsxs("div", { className: "px-4 py-3 flex items-center justify-between gap-4", style: { background: palette.white1 }, children: [_jsxs("div", { className: "min-w-0", children: [_jsx("div", { className: "font-medium truncate", children: s.title }), _jsxs("div", { className: "text-sm mt-1 flex flex-wrap gap-3", style: { color: palette.black2 }, children: [getPureLocation(s.room) && (_jsxs("span", { className: "flex items-center gap-1", children: [_jsx(MapPin, { size: 16 }), " ", getPureLocation(s.room)] })), _jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Clock, { size: 16 }), " ", s.time] })] })] }), _jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [_jsx(Btn, { palette: palette, size: "sm", variant: "ghost", onClick: () => openEdit(s), children: "Edit" }), _jsx(Btn, { palette: palette, size: "sm", variant: "quaternary", onClick: () => handleDelete(s), children: "Hapus" })] })] }, `${s.id ?? i}-${s.time}`))) }))] }, dateISO))) })] })] }) })] }));
}
