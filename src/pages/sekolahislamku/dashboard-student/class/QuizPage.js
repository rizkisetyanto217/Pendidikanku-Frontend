...
import { ArrowLeft, ClipboardList, Clock, Play, Pause, ChevronLeft, ChevronRight, CheckCircle2, RotateCcw, } from "lucide-react";
...
const StudentQuizPage = () => {
    ...
    const activeQuiz = useMemo(() => quizzes.find((q) => q.id === activeQid) || null, [activeQid, quizzes]);
    ...
    const next = () => setIdx((v) => Math.min((activeQuiz?.questions.length ?? 1) - 1, v + 1));
    const submit = async () => {
        if (!activeQuiz)
            return;
    ...
    return (_jsxs("div", { className: "min-h-screen w-full", style: { background: palette.white2, color: palette.black1 }, children: [_jsx(ParentTopBar, { palette: palette, title: `Kuis — ${classMeta.name}`, gregorianDate: new Date().toISOString(), showBack: true }), _jsx("main", { className: "w-full px-4 md:px-6 md:py-8", children: _jsxs("div", { className: "max-w-screen-2xl mx-auto flex flex-col lg:flex-row gap-4 lg:gap-6", children: [_jsx("aside", { className: "w-full lg:w-64 xl:w-72 flex-shrink-0", children: _jsx(ParentSidebar, { palette: palette }) }), _jsxs("div", { className: "flex-1 flex flex-col space-y-6 min-w-0", children: [_jsxs("div", { className: "md:flex hidden gap-3 items-center", children: [_jsx(Btn, { palette: palette, variant: "ghost", onClick: goBackToMyClass, children: _jsx(ArrowLeft, { size: 20 }) }), _jsx("h1", { className: "textlg font-semibold", children: "Daftar Kuis" })] }), _jsx("div", { className: "grid gap-3", children: quizzes.length === 0 ? (_jsx(SectionCard, { palette: palette, children: _jsx("div", { className: "p-6 text-sm text-center", style: { color: palette.silver2 }, children: "Belum ada kuis untuk kelas ini." }) })) : (quizzes.map((qz) => {
                                        const res = results[qz.id];
                                        return (_jsxs(SectionCard, { palette: palette, className: "p-0", children: [_jsx("div", { className: "p-4 md:p-5", children: _jsx("div", { className: "flex items-start justify-between gap-4", children: _jsxs("div", { className: "min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [_jsx("div", { className: "text-base md:text-lg font-semibold", style: { color: palette.black2 }, children: qz.title }), _jsx(Badge, { palette: palette, variant: res ? "success" : "outline", className: "h-6", children: res ? "Selesai" : "Belum dikerjakan" })] }), qz.description && (_jsx("p", { className: "text-sm mt-1", style: { color: palette.black2 }, children: qz.description })), _jsxs("div", { className: "mt-2 flex flex-wrap items-center gap-3 text-sm", style: { color: palette.black2 }, children: [_jsx(ClipboardList, { size: 14 }), _jsxs("span", { children: [qz.questions.length, " soal"] }), _jsx("span", { children: "\u2022" }), _jsx(Clock, { size: 14 }), _jsxs("span", { children: [qz.durationMin, " menit"] }), qz.dueAt && (_jsxs(_Fragment, { children: [_jsx("span", { children: "\u2022" }), _jsxs("span", { children: ["Deadline: ", dateLong(qz.dueAt)] })] })), res && (_jsxs(_Fragment, { children: [_jsx("span", { children: "\u2022" }), _jsx(CheckCircle2, { size: 14 }), _jsxs("span", { children: ["Skor: ", _jsx("b", { children: res.score }), " (", res.correct, "/", res.total, ")"] })] }))] })] }) }) }), _jsxs("div", { className: "px-4 md:px-5 pb-4 md:pb-5 pt-3 border-t flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3", style: { borderColor: palette.silver1 }, children: [_jsx("div", { className: "text-sm", style: { color: palette.black2 }, children: "Aksi" }), _jsxs("div", { className: "flex gap-2 flex-wrap", children: [!res && (_jsxs(Btn, { palette: palette, size: "sm", onClick: () => startQuiz(qz.id), children: [_jsx(Play, { size: 16, className: "mr-1" }), "Mulai"] })), res && (_jsxs(Btn, { palette: palette, size: "sm", variant: "secondary", onClick: () => resetAttempt(qz.id), children: [_jsx(RotateCcw, { size: 16, className: "mr-1" }), "Ulangi"] }))] })] })] }, qz.id));
                                    })) }), activeQuiz && (_jsx(SectionCard, { palette: palette, children: _jsxs("div", { className: "p-4 md:p-5 space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("div", { className: "font-semibold", children: activeQuiz.title }), _jsxs("div", { className: "text-sm flex items-center gap-2", style: { color: palette.black2 }, children: [_jsx(Clock, { size: 14 }), _jsxs("span", { children: ["Estimasi ", activeQuiz.durationMin, " menit"] })] })] }), _jsxs("div", { className: "text-sm", style: { color: palette.black2 }, children: ["Soal ", idx + 1, " / ", activeQuiz.questions.length] }), _jsxs("div", { className: "p-4 rounded-lg border", style: {
                                                    borderColor: palette.silver1,
                                                    background: palette.white1,
                                                }, children: [_jsx("div", { className: "font-medium mb-3", style: { color: palette.black2 }, children: activeQuiz.questions[idx].text }), _jsx("div", { className: "grid gap-2", children: activeQuiz.questions[idx].options.map((opt, i) => {
                                                            ...
                                                            ? "Jawaban dipilih."
                                                            : "Belum memilih jawaban." }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Btn, { palette: palette, variant: "secondary", onClick: prev, disabled: idx === 0, children: [_jsx(ChevronLeft, { size: 16, className: "mr-1" }), "Sebelumnya"] }), idx < activeQuiz.questions.length - 1 ? (_jsxs(Btn, { palette: palette, onClick: next, children: ["Selanjutnya", " ", _jsx(ChevronRight, { size: 16, className: "ml-1" })] })) : (_jsxs(Btn, { palette: palette, onClick: submit, children: [_jsx(Pause, { size: 16, className: "mr-1" }), "Kirim Jawaban"] }))] })] })] }) })), _jsx("div", { className: "md:hidden", children: _jsxs(Btn, { palette: palette, variant: "outline", onClick: goBackToMyClass, children: [_jsx(ArrowLeft, { size: 16, className: "mr-1" }), " Kembali ke Kelas"] }) })] })] }) })] }));
};
